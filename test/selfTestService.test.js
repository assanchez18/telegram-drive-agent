...
describe('selfTestService', () => {
  ...
  describe('executeSelfTest', () => {
    ...
    it('falla en paso 4 si no se pueden subir los archivos', async () => {
      vi.mocked(propertyService.listProperties)
        .mockResolvedValueOnce({ properties: [] })
        // Paso 3: Primer intento exitoso
      ...
      // Falla al subir foto
      vi.mocked(driveAdapter.uploadBufferToDrive).mockRejectedValueOnce(
    ...
    it('falla en paso 5 si no se puede archivar', async () => {
      vi.mocked(propertyService.listProperties)
        .mockResolvedValueOnce({ properties: [] })
        // Paso 3: Primer intento exitoso
        .mockResolvedValueOnce({
